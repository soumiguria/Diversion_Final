...
// //   const MarketTrendsPage({Key? key, required this.userPrompt}) : super(key: key);
...
// //   void initState() {
// //     super.initState();
// //     futureTrends = fetchTrends(widget.userPrompt);
// //   }
...
// //     String backgroundPrompt = "Provide market trends based on the user prompt: $userPrompt";
...
// //   Trend(String trend) : title = trend.split(':')[0], description = trend.split(':')[1];
// // }
...
//   void initState() {
//     super.initState();
//     // Don't initialize futureTrends in initState
//   }
...
//     // Initialize futureTrends lazily in the build method
//     futureTrends ??= fetchTrends(userPrompt);
